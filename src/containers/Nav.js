...
export default class Nav extends Component {
    ...
    render() {
        return (
            <div id="nav">
                <ul className="linetop">
                    <Link to='/home'onClick={this.props.logoReset} ><li><i class="fas fa-home"></i></li></Link>
                    <li>Current Balance: {this.numberFormat(this.props.currentUser.wallet)}</li>
                    <Link to='/wallet' onClick={this.props.logoReset}><li><i class="far fa-money-bill-alt"></i> Add Funds</li></Link>
                    ...
                    <Link to='/tutorial' onClick={this.props.logoReset}><li><i class="fas fa-book"></i> Tutorial</li></Link>
                    <Link to='/profile' onClick={this.props.logoReset}><li><i class="fas fa-user-circle"></i> Profile</li></Link>
