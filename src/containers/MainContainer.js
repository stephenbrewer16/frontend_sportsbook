            ...
            <div>
                <ul>
                    ...
                    <div>
                        ...
                        {this.state.nfl ? <NflContainer selectMatchup={this.props.selectMatchup} matchups={this.props.matchups} currentUser={this.props.currentUser} /> : null}
                    </div>
                    ...
                    <div>
                        ...
                        {this.state.nba ? <NbaContainer selectMatchup={this.props.selectMatchup} matchups={this.props.matchups} currentUser={this.props.currentUser} /> : null}
                    </div>
                    <button className="btn_category" onClick={this.hockeyClick}>NHL (Hockey)</button>
                    <div>
                        {this.state.nhl ?<h1>National Hockey League</h1> : null}
                        {this.state.nhl ? <NhlContainer selectMatchup={this.props.selectMatchup} matchups={this.props.matchups} currentUser={this.props.currentUser} /> : null}
                    </div>
                </ul>
            </div>
        )
